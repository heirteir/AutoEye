...
public class ChannelHandler1_8 extends ChannelHandlerAbstract {
    ...
    private io.netty.channel.Channel getChannel(Player player) {
        return (io.netty.channel.Channel) Reflections.getNMSClass("NetworkManager").getFirstFieldByType(io.netty.channel.Channel.class).get(ChannelHandlerAbstract.networkManagerField.get(ChannelHandlerAbstract.playerConnectionField.get(new WrappedEntity(autoeye, player).getRawEntity())));
    }
